...
- **archive**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/workspace/IDENTITY.md` -- No direct Hermes destination; archived for manual review
- **archive**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/workspace/TOOLS.md` -- No direct Hermes destination; archived for manual review
- **archive**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/workspace/HEARTBEAT.md` -- No direct Hermes destination; archived for manual review
- **archive**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/workspace/BOOTSTRAP.md` -- No direct Hermes destination; archived for manual review
- **archive**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/workspace/memory` -- No direct Hermes destination; archived for manual review
- **plugins-config**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/plugins-config.json` -- Plugins config archived for manual review
- **hooks-config**: `/home/banana/.hermes/migration/openclaw/20260401T164455/archive/hooks-config.json` -- Hooks config archived for manual review
- **gateway-config**: `archive/gateway-config.json` -- Gateway config archived. Use 'hermes gateway' to configure.
- **full-providers**: `archive/model-aliases.json` -- Model aliases/catalog (2 entries) archived
